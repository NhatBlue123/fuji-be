...
// @Transactional(readOnly = true)
// public Page<UserDTO> getAllUsers(int page, int size, String sortBy, String
// sortDir) {
// Sort sort = sortDir.equalsIgnoreCase("asc")
// ? Sort.by(sortBy).ascending()
// : Sort.by(sortBy).descending();
...
// public UserDTO createUser(UserDTO userDTO) {
//
// throw new UnsupportedOperationException("Chức năng tạo user chưa được
// implement");
// }
...
// public UserDTO updateUser(Long id, UserDTO userDTO) {
//
// throw new UnsupportedOperationException("Chức năng cập nhật user chưa được
// implement");
// }
...
// public void deleteUser(Long id) {
// if (!userRepository.existsById(id)) {
// throw new ResourceNotFoundException("Người dùng không tồn tại với id: " +
// id);
// }
// userRepository.deleteById(id);
// }
